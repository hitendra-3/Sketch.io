...
export default function BoardPage() {
  ...
  const roleFromUrl = searchParams.get("role") === "viewer" ? "viewer" : "editor";
  ...
  const stylesFadeTimerRef = useRef(null);
  ...
  // Point-batch buffer
  const pointBatchRef = useRef(new Map());
  ...
  const sendStrokePoint = useCallback((strokeId, point) => {
